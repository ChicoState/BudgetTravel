...
const Introduction = ({ navigation }) => {
  ...
  const handleDestinationNavigation = (destination) => {
    desti = destination;
    navigation.navigate('PlanTripScreen1', { dest: destination });
  };
...
<View style={styles.container}>
  <View style={styles.column}>
    ...
    <TouchableOpacity onPress={() => handleDestinationNavigation('Costa Rica')}
  style={styles.container}>
    ...
    <TouchableOpacity onPress={() => handleDestinationNavigation('Tijuana, Mexico')}
  style={styles.container}>
    <View style={styles.box}>
     	<Image
        	style={styles.image}
    ...
    <TouchableOpacity onPress={() => handleDestinationNavigation('Tokyo, Japan')}
  style={styles.container}>
      <View style={styles.box}>
     	<Image
        	style={styles.image}
    ...
    <TouchableOpacity onPress={() => handleDestinationNavigation('San Diego')}
